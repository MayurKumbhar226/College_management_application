...
RecyclerView convoRecycler, otherRecycler,IndependanceRecycler;
...
DatabaseReference reference;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        IndependanceRecycler = view.findViewById(R.id.IndependanceRecycler);
    ...
    private void IndependanceImage() {
        ...
        reference.child("Independance Day").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                IndependanceRecycler.setLayoutManager(new GridLayoutManager(getContext(), 3));
                IndependanceRecycler.setAdapter(adapter);
