    ...
    private void deleteData() {
        reference.child(category).child(uniqueKey).removeValue()
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(UpdateTeacherActivity.this, "Sonthing is Wrong ", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updateData(String s) {
        ...
        reference.child(category).child(uniqueKey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(UpdateTeacherActivity.this, "Somthing is Wrong...", Toast.LENGTH_SHORT).show();
            }
        });
